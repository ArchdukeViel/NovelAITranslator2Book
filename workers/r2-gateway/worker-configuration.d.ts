/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6cc463ddeead8d7a01684432bd68dc1e)
...
interface __BaseEnv_Env {
	...
	APP_CLIENT_ID: "test-app-client" | "configure-in-cloudflare-access";
	RECOVERY_CLIENT_ID: "test-recovery-client" | "configure-in-cloudflare-access";
}
declare namespace Cloudflare {
	...
	interface TestEnv {
		...
		RECOVERY_CLIENT_ID: "test-recovery-client";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GATEWAY_VERSION" | "MAX_OBJECT_BYTES" | "APP_CLIENT_ID" | "RECOVERY_CLIENT_ID">> {}
}
