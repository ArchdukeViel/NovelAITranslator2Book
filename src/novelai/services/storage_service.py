...
class StorageService:
    ...
    def _translation_versions_from_payload(self, payload: dict[str, Any]) -> list[dict[str, Any]]:
    ...
    def _active_translation_version(self, payload: dict[str, Any]) -> dict[str, Any] | None:
    ...
    def load_translation_edit_history(self, novel_id: str, chapter_id: str) -> list[dict[str, Any]]:
