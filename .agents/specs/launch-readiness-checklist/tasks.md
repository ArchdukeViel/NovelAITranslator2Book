...
- [x] T-001 Assign sanitized gate ownership
  ...
  - Verification: `rg -n "owner|reviewer|launch|rollback|monitoring|security|recovery|accessibility|performance|SEO|legal" docs/STATUS.md`
  ...
  - Evidence: `docs/STATUS.md`; `artifacts/operations/reader-capacity-follow-up/recovery-owner-and-rotation.md`
...
- [ ] T-002 Freeze and reconcile the exact candidate
  ...
  - Verification: `docs/STATUS.md` candidate and gate rows plus hosted/manual evidence links.
  ...
  - Evidence: `docs/STATUS.md`; `docs/EVIDENCE.md`; current CI artifacts where explicitly labeled.
...
- [ ] T-003 Resolve blockers or record formal waivers
  ...
  - Verification: Each row in `docs/STATUS.md` has independent evidence or an owner/approver/expiry waiver.
  ...
  - Evidence: `docs/STATUS.md` current NO-GO register.
...
- [x] T-004 Record current final decision and monitoring ownership
  ...
  - Verification: `rg -n "NO-GO|production_capacity_claim|monitoring|rollback" docs/STATUS.md docs/EVIDENCE.md`
  ...
  - Evidence: `docs/STATUS.md`; `docs/EVIDENCE.md`; this specification.
...
- [ ] T-005 Archive only after verified GO
  ...
  - Scope: Summarize verified evidence in `docs/EVIDENCE.md` and archive this spec only after a real `GO`.
  - Verification: `Test-Path docs/EVIDENCE.md` and `Test-Path docs/archive/specs/launch-readiness-checklist`
  ...
  - Evidence: Active spec remains under `.agents/specs/launch-readiness-checklist/`; `docs/STATUS.md` remains NO-GO.
