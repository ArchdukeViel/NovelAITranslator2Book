...
- [ ] 1. Complete prerequisites
  ...
  - [ ] 1.2 Ship deterministic QA checks and parser tests (REQ-3.1)

- [ ] 2. Build evaluation fixtures
  - [ ] 2.1 Create accepted fuzzy-match examples (REQ-1.2)
  - [ ] 2.2 Create rejected fuzzy-match examples where context changes meaning (REQ-1.2)
  - [ ] 2.3 Define precision threshold for enabling reuse (REQ-1.4)
...
- [ ] 4. Design LLM QA output
  ...
  - [ ] 4.2 Add parser tests for valid/invalid output (REQ-4.2)
  - [ ] 4.3 Keep initial behavior review-flag only (REQ-3.3)

- [ ] 5. Add disabled-by-default config checks
  - [ ] 5.1 Test semantic cache disabled by default (REQ-4.3)
  - [ ] 5.2 Test LLM QA disabled by default (REQ-4.3)