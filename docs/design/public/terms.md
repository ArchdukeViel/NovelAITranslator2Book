...
## Design Task
Design the terms of service as numbered static prose sections.

## Product Context
A static legal trust page covering reader accounts, requests, reviews, and optional contributor credential use.
...
- Dokushodo
- Terms of Service
- Contributor credential use and quotas
...
## Avoid
- Accept buttons on a static page
- Decorative icons
