...
## Design Task
Design the legal index page linking to policy documents.

## Product Context
A static trust page linking privacy, terms, DMCA, and cookie policy, including the first-party anonymous ranking-token notice.
...
## Page Goal
Route readers to the right policy document.

## Audience and Access
All visitors.

## Primary Action
Opening a linked policy document.

## Information Hierarchy
- Eyebrow Dokushodo
- Heading Legal
- Link list to policy documents

## Desktop Composition
- Centered column with a quiet list of document links
...
- DMCA
- Cookie Policy
- Anonymous ranking-token notice

## Normal Settled State
A quiet centered link list on washi paper.
...
## Preserve Exactly
- Document link labels exactly as listed

## Avoid
- Documents embedded inline
- Decorative icons
