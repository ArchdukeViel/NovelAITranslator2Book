...
## Design Task
Design the privacy policy as numbered static prose sections.

## Product Context
A static legal trust page explaining account data, contributor credential handling, and privacy-safe anonymous ranking identity.
...
- Dokushodo
- Privacy Policy
- Anonymous viewer-token digest, not an IP address
...
- Eyebrow label
- Clear distinction between authenticated ids and anonymous viewer digests
