...
## Design Task
Design the about page as numbered static prose sections.

## Product Context
A static informational page in the public trust group.
...
## Page Goal
Tell the project story plainly and quickly.
...
- Eyebrow Dokushodo
- Heading About Dokushodo
- Description line
- Numbered prose sections

## Desktop Composition
- Single centered column with restrained width
- Numbered sections with short headings and paragraphs
...
Plain prose on washi paper with a small eyebrow above the heading and numbered sections below.

## Alternate Visual States
- None; single settled layout

## Interaction Cues
- None; non-interactive prose
...
## Avoid
- Team photos or decorative headers
