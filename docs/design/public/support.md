...
## Design Task
Design the support page as numbered help sections with a contact path.
...
## Page Goal
Answer common support questions and route to contact.

## Audience and Access
All visitors.

## Primary Action
Opening the contact path.

## Information Hierarchy
- Eyebrow Dokushodo
- Heading Support
- Numbered help sections
- Contact link

## Desktop Composition
- Centered column with numbered sections and a quiet contact link at the end
...
Plain help prose with one quiet contact link.

## Alternate Visual States
- None

## Interaction Cues
- Contact link underlines on hover
