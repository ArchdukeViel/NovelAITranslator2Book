...
## Design Task
Design the FAQ as numbered static prose sections.
...
- Each question a numbered section with a prose answer
...
Plain question and answer prose on washi paper.
...
## Avoid
- Accordion interactivity not present in the page
- Invented Q and A content
