...
## Design Task
Design the 404 page with the 404 illustration and clear exits.

## Product Context
Shown for any route that does not exist; the global error boundary delegates here.
...
## Page Goal
Tell the reader the page is missing and get them back on track.
...
## Desktop Composition
- Centered block: illustration above heading, actions below
- Two quiet actions side by side

## Mobile Composition
- Same centered block stacked
- Actions full width
...
One quiet centered illustration, a plain heading, and two links; no alarm styling.
...
- Illustration is static and quiet
