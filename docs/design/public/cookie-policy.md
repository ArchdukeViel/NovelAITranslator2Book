# Dokushodo - Cookie Policy

## Design Task
Design the cookie policy as numbered static prose sections.

## Product Context
A static legal trust page explaining session cookies, CSRF support, and the signed first-party anonymous viewer token used for privacy-safe novel-detail rankings.
...
## Desktop Composition
- Single centered column with restrained width
...
- Dokushodo
- Cookie Policy
- First-party anonymous viewer token

## Normal Settled State
Plain numbered prose on washi paper.
...
- Eyebrow label
- No IP address storage in anonymous ranking identity

## Avoid
- Cookie banner mockups
- Decorative icons
