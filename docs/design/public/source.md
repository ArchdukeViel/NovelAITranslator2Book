...
- Source name as the page title
- Preset chip reading Source: followed by the source name
- Browse all novels link to clear the preset

## Normal Settled State
A source-titled grid with one quiet chip marking the scope.

## Alternate Visual States
- Empty source with the empty illustration and a browse all novels action
...
## Preserve Exactly
- Source name in the title exactly as branded by the source
- Chip label format Source: name

## Avoid
- Source logos rendered large or animated
- Claims of official affiliation with the source
