...
down_revision: str | Sequence[str] | None = "d9b7e2a1c4f6"
...
def upgrade() -> None:
    ...
    with op.batch_alter_table("novels") as batch_op:
        ...
        batch_op.add_column(sa.Column("chapter_count", sa.Integer(), nullable=False, server_default="0"))
        batch_op.add_column(sa.Column("translated_count", sa.Integer(), nullable=False, server_default="0"))
        ...
        batch_op.add_column(sa.Column("latest_chapter_updated_at", sa.DateTime(timezone=True), nullable=True))
