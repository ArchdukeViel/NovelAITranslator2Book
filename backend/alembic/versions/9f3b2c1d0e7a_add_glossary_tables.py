...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["created_by_user_id"],
            ["users.id"],
            name=op.f("fk_novel_glossary_entries_created_by_user_id_users"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["first_seen_chapter_id"],
            ["chapters.id"],
            name=op.f("fk_novel_glossary_entries_first_seen_chapter_id_chapters"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["last_seen_chapter_id"],
            ["chapters.id"],
            name=op.f("fk_novel_glossary_entries_last_seen_chapter_id_chapters"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["novel_id"], ["novels.id"], name=op.f("fk_novel_glossary_entries_novel_id_novels"), ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["updated_by_user_id"],
            ["users.id"],
            name=op.f("fk_novel_glossary_entries_updated_by_user_id_users"),
            ondelete="SET NULL",
        ),
    ...
    op.create_index(
        "ix_novel_glossary_entries_novel_id_canonical_term",
        "novel_glossary_entries",
        ["novel_id", "canonical_term"],
        unique=False,
    )
    op.create_index(
        "ix_novel_glossary_entries_novel_id_public_visible",
        "novel_glossary_entries",
        ["novel_id", "public_visible"],
        unique=False,
    )
    op.create_index(
        "ix_novel_glossary_entries_novel_id_status", "novel_glossary_entries", ["novel_id", "status"], unique=False
    )
    op.create_index(
        "ix_novel_glossary_entries_novel_id_term_type",
        "novel_glossary_entries",
        ["novel_id", "term_type"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["glossary_entry_id"],
            ["novel_glossary_entries.id"],
            name=op.f("fk_novel_glossary_aliases_glossary_entry_id_novel_glossary_entries"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["novel_id"], ["novels.id"], name=op.f("fk_novel_glossary_aliases_novel_id_novels"), ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_novel_glossary_aliases")),
    )
    op.create_index(
        op.f("ix_novel_glossary_aliases_glossary_entry_id"),
        "novel_glossary_aliases",
        ["glossary_entry_id"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_novel_glossary_aliases_entry_type",
        "novel_glossary_aliases",
        ["glossary_entry_id", "alias_type"],
        unique=False,
    )
    op.create_index(
        "ix_novel_glossary_aliases_novel_alias_type",
        "novel_glossary_aliases",
        ["novel_id", "alias_text", "alias_type"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["chapter_id"],
            ["chapters.id"],
            name=op.f("fk_novel_glossary_source_provenance_chapter_id_chapters"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["glossary_entry_id"],
            ["novel_glossary_entries.id"],
            name=op.f("fk_novel_glossary_source_provenance_glossary_entry_id_novel_glossary_entries"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["novel_id"],
            ["novels.id"],
            name=op.f("fk_novel_glossary_source_provenance_novel_id_novels"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_novel_glossary_source_provenance")),
    )
    op.create_index(
        op.f("ix_novel_glossary_source_provenance_chapter_id"),
        "novel_glossary_source_provenance",
        ["chapter_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_novel_glossary_source_provenance_glossary_entry_id"),
        "novel_glossary_source_provenance",
        ["glossary_entry_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_novel_glossary_source_provenance_novel_id"),
        "novel_glossary_source_provenance",
        ["novel_id"],
        unique=False,
    )
    op.create_index(
        "ix_novel_glossary_source_provenance_entry_source",
        "novel_glossary_source_provenance",
        ["glossary_entry_id", "source_site"],
        unique=False,
    )
    op.create_index(
        "ix_novel_glossary_source_provenance_novel_source",
        "novel_glossary_source_provenance",
        ["novel_id", "source_site", "source_novel_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["actor_user_id"],
            ["users.id"],
            name=op.f("fk_novel_glossary_decision_events_actor_user_id_users"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["alias_id"],
            ["novel_glossary_aliases.id"],
            name=op.f("fk_novel_glossary_decision_events_alias_id_novel_glossary_aliases"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["glossary_entry_id"],
            ["novel_glossary_entries.id"],
            name=op.f("fk_novel_glossary_decision_events_glossary_entry_id_novel_glossary_entries"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["novel_id"],
            ["novels.id"],
            name=op.f("fk_novel_glossary_decision_events_novel_id_novels"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_novel_glossary_decision_events")),
    )
    op.create_index(
        op.f("ix_novel_glossary_decision_events_actor_user_id"),
        "novel_glossary_decision_events",
        ["actor_user_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_novel_glossary_decision_events_glossary_entry_id"),
        "novel_glossary_decision_events",
        ["glossary_entry_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_novel_glossary_decision_events_novel_id"), "novel_glossary_decision_events", ["novel_id"], unique=False
    )
    op.create_index(
        "ix_novel_glossary_decision_events_entry_created",
        "novel_glossary_decision_events",
        ["glossary_entry_id", "created_at"],
        unique=False,
    )
    op.create_index(
        "ix_novel_glossary_decision_events_novel_created",
        "novel_glossary_decision_events",
        ["novel_id", "created_at"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["chapter_id"],
            ["chapters.id"],
            name=op.f("fk_novel_glossary_qa_findings_chapter_id_chapters"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["glossary_entry_id"],
            ["novel_glossary_entries.id"],
            name=op.f("fk_novel_glossary_qa_findings_glossary_entry_id_novel_glossary_entries"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["novel_id"], ["novels.id"], name=op.f("fk_novel_glossary_qa_findings_novel_id_novels"), ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["reviewer_user_id"],
            ["users.id"],
            name=op.f("fk_novel_glossary_qa_findings_reviewer_user_id_users"),
            ondelete="SET NULL",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_novel_glossary_qa_findings")),
    )
    op.create_index(
        op.f("ix_novel_glossary_qa_findings_chapter_id"), "novel_glossary_qa_findings", ["chapter_id"], unique=False
    )
    op.create_index(
        op.f("ix_novel_glossary_qa_findings_glossary_entry_id"),
        "novel_glossary_qa_findings",
        ["glossary_entry_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_novel_glossary_qa_findings_novel_id"), "novel_glossary_qa_findings", ["novel_id"], unique=False
    )
    op.create_index(
        "ix_novel_glossary_qa_findings_chapter_status",
        "novel_glossary_qa_findings",
        ["chapter_id", "status"],
        unique=False,
    )
    op.create_index(
        "ix_novel_glossary_qa_findings_entry_status",
        "novel_glossary_qa_findings",
        ["glossary_entry_id", "status"],
        unique=False,
    )
    op.create_index(
        "ix_novel_glossary_qa_findings_novel_chapter_status_severity",
        "novel_glossary_qa_findings",
        ["novel_id", "chapter_id", "status", "severity"],
        unique=False,
    )
    op.create_index(
        "ix_novel_glossary_qa_findings_novel_status_severity",
        "novel_glossary_qa_findings",
        ["novel_id", "status", "severity"],
        unique=False,
    )
    op.create_index(
        "ix_novel_glossary_qa_findings_type_severity",
        "novel_glossary_qa_findings",
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["glossary_entry_id"],
            ["novel_glossary_entries.id"],
            name=op.f("fk_user_glossary_display_overrides_glossary_entry_id_novel_glossary_entries"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["novel_id"],
            ["novels.id"],
            name=op.f("fk_user_glossary_display_overrides_novel_id_novels"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["user_id"], ["users.id"], name=op.f("fk_user_glossary_display_overrides_user_id_users"), ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_user_glossary_display_overrides")),
        sa.UniqueConstraint(
            "user_id", "novel_id", "glossary_entry_id", name=op.f("uq_user_glossary_display_overrides_user_novel_entry")
        ),
    )
    op.create_index(
        op.f("ix_user_glossary_display_overrides_glossary_entry_id"),
        "user_glossary_display_overrides",
        ["glossary_entry_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_user_glossary_display_overrides_novel_id"),
        "user_glossary_display_overrides",
        ["novel_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_user_glossary_display_overrides_user_id"), "user_glossary_display_overrides", ["user_id"], unique=False
    )
    op.create_index(
        "ix_user_glossary_display_overrides_novel_entry",
        "user_glossary_display_overrides",
        ["novel_id", "glossary_entry_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_user_glossary_display_overrides_glossary_entry_id"), table_name="user_glossary_display_overrides"
    )
    ...
    op.drop_index(
        "ix_novel_glossary_qa_findings_novel_chapter_status_severity", table_name="novel_glossary_qa_findings"
    )
    ...
    op.drop_index(
        op.f("ix_novel_glossary_decision_events_glossary_entry_id"), table_name="novel_glossary_decision_events"
    )
    ...
    op.drop_index(
        op.f("ix_novel_glossary_source_provenance_glossary_entry_id"), table_name="novel_glossary_source_provenance"
    )
